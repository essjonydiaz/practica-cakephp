...
return [
    ...
    'Datasources' => [
        ...
        'default' => [
             ...
             *
             * - En local (docker-compose) los valores por defecto apuntan al
             *   servicio `db` de MariaDB, asi que no hay que configurar nada.
             * - En produccion (Vercel) basta definir DATABASE_URL con el DSN
             *   completo de la base de datos externa; si esta presente tiene
             *   prioridad sobre los valores individuales de abajo.
             */
            'host' => env('DB_HOST', 'db'),
            ...
            'flags' => [
                /*
                 * Sin timeout, una base inalcanzable deja la peticion colgada
                 * hasta que Vercel responde 504. Con 5s falla rapido y la
                 * pagina se renderiza mostrando el error de conexion.
                 */
